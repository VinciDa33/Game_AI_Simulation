...
public class VaccinePolicy : Policy
{
    ...
    {
        if (isEnabled)
            world.worldState.happiness -= (int) Math.Floor(world.population.Count * 0.003f); //In a population of 1000, the starting happiness will be 5000, and this number will be 3 (per hour)
    }
